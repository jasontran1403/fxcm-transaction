...
const Invest = () => {
    ...
    return (
        <AdminLayout>
            <div className="col-span-5 px-4 py-3 bg-white border rounded-md shadow-xs lg:col-span-3 md:col-span-6 text-center">
                <div className="flex col-span-1 mt-3 justify-center">
