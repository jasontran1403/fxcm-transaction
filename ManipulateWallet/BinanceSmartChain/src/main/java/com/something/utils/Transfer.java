...
//		String smartContract = "0x337610d27c682E347C9cD60BD4b3b107C9d34dDd";
		...
		// Build the transaction
		BigInteger gasPrice = Convert.toWei("10", Convert.Unit.GWEI).toBigInteger(); // 10 Gwei
		BigInteger gasLimit = BigInteger.valueOf(100000); // 100,000
